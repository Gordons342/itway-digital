(function () {
  ...
  const translations = {
    uk: {
      ...
      ai_showcase_alt: "AI-асистент: монітор, чат-бот і автоматизація бізнес-процесів",
    ...
    en: {
      ...
      ai_showcase_alt: "AI assistant: monitor, chatbot, and business process automation",
